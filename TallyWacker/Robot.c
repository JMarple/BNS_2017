...
#define LIFT_SUPER_LOW_HEIGHT 1000
#define LIFT_LOW_HEIGHT 100
#define LIFT_LITTLE_BIT_HEIGHT -200
#define LIFT_MID_CUBE_HEIGHT -600
#define LIFT_SIDE_PUSH_HEIGHT -700
#define LIFT_MID_HEIGHT -750
#define LIFT_NEARLY_HIGH_HEIGHT -900
#define LIFT_HIGH_HEIGHT -1000
...
void liftPower(int power)
{
	...
	motor[liftL2] = motor[liftR2] = power;
}
...
float getLiftHeight()
{
  if (SensorValue[liftLowerLimit] == 0)
  {
